...
contract StarNotary is ERC721 {
    ...
    constructor() ERC721("Stella", "STL") {}

    // mapping the Star's TokenId to the Star
    mapping(uint256 => Star) public tokenIdToStarInfo;
    // mapping the Star's TokenId to the Price
    ...
    function createStar(string memory _name, uint256 _tokenId) public {
        ...
        tokenIdToStarInfo[_tokenId] = newStar; // Creating in memory the tokenId -> Star mapping
        _mint(msg.sender, _tokenId); // _mint assign the star's _tokenId to the sender address (ownership)
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        bool ownsOneStar = ((ownerOfToken1 == sender) &&
            (ownerOfToken2 != sender)) ||
            ((ownerOfToken2 == sender) && (ownerOfToken1 != sender));
        require(ownsOneStar, "You should own one of the stars.");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        bool senderIsOwner = ownerOfToken == msg.sender;
        require(senderIsOwner, "You should own the star.");
